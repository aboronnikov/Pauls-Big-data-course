...
private object FeedbackMessageConstants {
   ...
   */
  val BadArgsProblem = "You have provided bad arguments, you can specify \"-help\" to ask for help with this program."

  /**
   * This is the message to be displayed in case of an IO problem.
   */
  val IOProblem = "There was a problem while reading from schema/csvFile, or writing to the parquet file."

  /**
   * The message is displayed when all operations have completed successfully.
   */
  val Success = "Your csv has been successfully converted."

  /**
   * The message is displayed when an unaccounted exception is thrown.
   */
  val UnknownProblem = "An unknown problem occurred."

  /**
   * The message is displayed when the user provides a bad schema or a corrupted csv file.
   */
  val BadNumberFormat = "Either your file's schema is wrong or the contents of your csv file are corrupted."
}
