 ...
 */
public class UnboundedTwitterProducer implements TwitterProducer {

    /**
     * Default logger.
     */
    private static final Logger LOG = Logger.getLogger(UnboundedTwitterProducer.class);
     ...
     */
    public UnboundedTwitterProducer(BlockingQueue<String> queue, String topic, Producer<String, String> producer, Client client) {
        this.queue = queue;
        this.topic = topic;
